...
yum install -y puppet-server postgresql-server foreman-proxy foreman-postgresql tftp-server syslinux httpd foreman-cli mod_passenger mod_ssl tfm-rubygem-passenger-native
